...
void displayAbout() {
	...
	printText(-3.5, 6.5, "RUBIKS is a program designed using OpenGL to help Rubiks cube1 enthusiasts play ", 1, GLUT_STROKE_ROMAN, colorList[3], 1);
	...
	printText(-3.5, 6.1, "allows the user to smoothly move and rotate a cube1. This program can handle a ", 1, GLUT_STROKE_ROMAN, colorList[3], 1);
	printText(-3.5, 5.9, "50x50x50 with ease. The size of the cube1 is only limited by the memory and ", 1, GLUT_STROKE_ROMAN, colorList[3], 1);
